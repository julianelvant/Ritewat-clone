        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-white mb-6">
              Providing reliable power solutions tailored to the needs of
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start">
                ...
                <span className="text-white">+44 774 617 6656</span>
              </li>
              <li className="flex items-start">
                <svg
                  className="w-6 h-6 text-primary mr-3 mt-1"
                ...
                <span className="text-white">enquiries@ritewat.uk</span>
              </li>
              <li className="flex items-start">
                <svg
                  className="w-6 h-6 text-primary mr-3 mt-1"
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-col md:flex-row items-center gap-2 mb-4 md:mb-0">
              <p className="text-white text-sm mb-4 md:mb-0">
                &copy; {new Date().getFullYear()} RiteWat UK Ltd. All rights
                reserved.
              </p>
              <span className="hidden md:inline text-gray-500">|</span>
                ...
                Powered by{" "}
                <a
                  href="https://cytsoftware.com"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-[#ff8c33] transition-colors"
                >
                  Cyt Software
                </a>
                </p>
